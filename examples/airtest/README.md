...
- [record_android_app.py](record_android_app.py) — Android: full run with `on_step` logging and a device-screen recording (`record_device=True`) embedded in the report
