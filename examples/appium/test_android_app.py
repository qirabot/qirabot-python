...
bot = Qirabot(task_name="test-my-app", screenshot_dir="./screenshots")
...
def test_navigate_tabs():
    ...
    bot.click(driver, "Second tab in bottom navigation")
    title = bot.extract(driver, "What is the page title?")
    assert title
